...
3. Install **MATLAB Runtime R2026a**, then run the same launcher again.

## Required runtime
This app expects **MATLAB Runtime R2026a**.
...
- Optional runtime override:
  - Windows: `run_perceive_gui_startup.bat --runtime-path "C:\Path\To\MATLAB Runtime\R2026a"`
  - macOS/Linux: `./run_perceive_gui_startup.sh --runtime-path /path/to/MATLAB_Runtime_R2026a`
